...
class RNN:
    ...
    def __init__(self, vocab_size=4, word_dimension=64, class_num=2, unit_num=128, layer_num=4):
    ...
    def train_writer(self):
        return tf.summary.FileWriter('../../log/lstm_train', self.sess.graph)
...
def train_model():
    global data
    data = Data.Data("../../data/comment.csv")
